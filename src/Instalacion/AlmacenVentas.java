...
public class AlmacenVentas {
    ...
    public Te[] getVentasTe() {
        return ventasTe;
    }
    
    public Chocolate[] getVentasChocolate() {
        return ventasChocolate;
    }
    
    public CafeExpresso[] getVentasCafeExpresso() {
        return ventasCafeExpresso;
    }
    
    public CafeLargo[] getVentasCafeLargo() {
        return ventasCafeLargo;
    }
    
    public CafeConLeche[] getVentasCafeConLeche() {
        return ventasCafeConLeche;
    }
    ...
    //En cada metodo se recorre cada objeto guardado en el array y se suma el precio de venta que tuvo cada objeto
    
    public double precioCafesConLecheVendidos() {
        if (contadorCafeConLeche == 0) {
            return 0;
        } else {
    ...
    public int getTotalVentas() {
        return contadorCafeConLeche + contadorCafeExpresso + contadorCafeLargo + contadorChocolate + contadorTe;
    }
    
    public double getTotalPrecio() {
        return precioCafesExpressosVendidos() + precioCafesLargosVendidos() + precioCafesConLecheVendidos() + precioTesVendidos() + precioChocolatesVendidos();
    }
    ...
    public String toString() {
        return String.format("""
            ...
            TOTAL:          %d ventas - %.2f €
            """, contadorCafeExpresso, precioCafesExpressosVendidos(), contadorCafeLargo, precioCafesLargosVendidos(), contadorCafeConLeche, precioCafesConLecheVendidos(), contadorTe, precioTesVendidos(), contadorChocolate, precioChocolatesVendidos(), getTotalVentas(), getTotalPrecio());
    }
}